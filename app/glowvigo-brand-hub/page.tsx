    ...
    <div className="bg-stone-50 min-h-screen font-body">
      ...
      <main id="the-selection" className="max-w-6xl mx-auto px-6 py-16 scroll-mt-20">
            ...
            <div className="p-8 lg:p-12">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-xs font-semibold tracking-widest uppercase text-stone-400 mb-5">
                  The Patented Cellular Energy Activator
                </p>
                <p className="text-stone-300 text-lg leading-relaxed mb-8">
                  At the heart of every Glowvigo formula is the{" "}
                  <em className="text-white font-semibold">
                    Saffron Extract Complex
                  </em>{" "}
                  — a clinically studied active derived from one of the world&rsquo;s
                  most precious botanical sources. Its unique molecular profile
                  targets oxidative stress at the cellular level, the primary
                  driver of stress-aging and luminosity loss.
                </p>
                <p className="text-stone-400 leading-relaxed mb-10">
                  Clinical studies demonstrate that saffron&rsquo;s crocin and
                  safranal compounds directly activate cellular energy pathways,
                  enhancing mitochondrial function and reducing the inflammatory
                  cascade that accelerates visible aging. Combined with its
                  documented ability to support emotional balance — a key factor
                  in stress-related skin degradation — it is the cornerstone of
                  the Glowvigo inside-out approach to luminosity.
                </p>
                <div className="grid grid-cols-3 gap-6 border-t border-stone-700 pt-8">
                  <div className="text-center">
                    <p className="font-display text-2xl font-bold text-amber-400 mb-1">
                      10+
                    </p>
                    <p className="text-xs text-stone-500 uppercase tracking-wider font-medium">
        ...
        {/* ══════════════════════════════════════════════════════════════
            EXPERT VERDICTS
        ══════════════════════════════════════════════════════════════ */}
        <section id="expert-verdicts" className="mt-20 scroll-mt-20">
          <div className="mb-10 border-b border-stone-200 pb-8">
            ...
            <p className="text-stone-500 mt-3 max-w-xl">
              Our editorial team&rsquo;s definitive conclusion on each formula
              in the Glowvigo Core 4 system.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {products.map((product) => (
              <div
                key={`verdict-${product.id}`}
